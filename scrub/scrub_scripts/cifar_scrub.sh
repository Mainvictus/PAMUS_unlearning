...
# outfile='results/cifar_scrub(origin).csv'
# train () {
...
#!/bin/bash
echo 'Running CIFAR ResNet18 Scrubbing Script...'
...
outfile='results/cifar_scrub_resnet18(origin).csv'
train () {
